import { Controller, SetMetadata, Type, UseInterceptors, applyDecorators } from '@nestjs/common';
import { V1ResponseFormatter, V1_RESPONSE_FORMATTER_KEY } from './v1-response-formatter.interface';
 ...
 */
export function V1Controller(path: string, formatter: Type<V1ResponseFormatter>): ClassDecorator {
